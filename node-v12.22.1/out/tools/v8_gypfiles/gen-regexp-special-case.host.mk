...
$(OBJS): | $(obj).host/tools/v8_gypfiles/libv8_libbase.a $(obj).host/tools/v8_gypfiles/v8_maybe_icu.stamp $(obj).host/tools/v8_gypfiles/v8_headers.stamp $(obj).host/tools/v8_gypfiles/v8_version.stamp $(obj).host/tools/icu/icui18n.stamp $(obj).host/tools/icu/libicutools.a $(obj).host/tools/icu/icu_implementation.stamp $(obj).host/tools/icu/icu_uconfig.stamp $(obj).host/tools/icu/icuuc.stamp
...
$(builddir)/gen-regexp-special-case: LD_INPUTS := $(OBJS) $(obj).host/tools/v8_gypfiles/libv8_libbase.a $(obj).host/tools/icu/libicutools.a
$(builddir)/gen-regexp-special-case: TOOLSET := $(TOOLSET)
$(builddir)/gen-regexp-special-case: $(OBJS) $(obj).host/tools/v8_gypfiles/libv8_libbase.a $(obj).host/tools/icu/libicutools.a FORCE_DO_CMD
	$(call do_cmd,link)
