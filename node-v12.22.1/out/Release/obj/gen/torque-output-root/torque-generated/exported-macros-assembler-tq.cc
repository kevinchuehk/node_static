...
return TestOrAnd_456(state_, p_x, p_y, p_z);
}
...
return TestAndOr_457(state_, p_x, p_y, p_z);
}
void TorqueGeneratedExportedMacrosAssembler::TestLogicalOperators(){
return TestLogicalOperators_458(state_);
}
...
return TestCatch3WrapperWithLabel_468(state_, p_context, label__Abort);
}
compiler::TNode<Smi> TorqueGeneratedExportedMacrosAssembler::TestCatch3(compiler::TNode<Context> p_context){
return TestCatch3_469(state_, p_context);
}
...
return TestGenericStruct2_487(state_);
}
...
return TestBranchOnBoolOptimization_489(state_, p_context, p_input);
}
...
return StoreEnumCacheIndices_579(state_, p_o, p_v);
}
...
return LoadSourcePositionTableWithFrameCacheSourcePositionTable_580(state_, p_o);
}
...
return StoreSourcePositionTableWithFrameCacheSourcePositionTable_581(state_, p_o, p_v);
}
...
return LoadSourcePositionTableWithFrameCacheStackFrameCache_582(state_, p_o);
}
...
return StoreSourcePositionTableWithFrameCacheStackFrameCache_583(state_, p_o, p_v);
}
...
return LoadDescriptorArrayNumberOfAllDescriptors_584(state_, p_o);
}
...
return StoreDescriptorArrayNumberOfAllDescriptors_585(state_, p_o, p_v);
}
...
return LoadDescriptorArrayNumberOfDescriptors_586(state_, p_o);
}
...
return StoreDescriptorArrayNumberOfDescriptors_587(state_, p_o, p_v);
}
...
return LoadDescriptorArrayRawNumberOfMarkedDescriptors_588(state_, p_o);
}
...
return StoreDescriptorArrayRawNumberOfMarkedDescriptors_589(state_, p_o, p_v);
}
...
return LoadDescriptorArrayFiller16Bits_590(state_, p_o);
}
...
return StoreDescriptorArrayFiller16Bits_591(state_, p_o, p_v);
}
...
return LoadDescriptorArrayEnumCache_592(state_, p_o);
}
...
return StoreJSObjectElements_595(state_, p_o, p_v);
}
...
return LoadJSFunctionSharedFunctionInfo_596(state_, p_o);
}
...
return StoreJSFunctionContext_599(state_, p_o, p_v);
}
...
return LoadJSFunctionFeedbackCell_600(state_, p_o);
}
...
return LoadJSFunctionPrototypeOrInitialMap_604(state_, p_o);
}
...
return LoadJSProxyRevocableResultProxy_610(state_, p_o);
}
...
return StoreJSProxyRevocableResultProxy_611(state_, p_o, p_v);
}
...
return LoadJSProxyRevocableResultRevoke_612(state_, p_o);
}
...
return StoreJSProxyRevocableResultRevoke_613(state_, p_o, p_v);
}
...
return LoadJSGlobalProxyNativeContext_614(state_, p_o);
}
...
return StoreJSGlobalProxyNativeContext_615(state_, p_o, p_v);
}
...
return LoadJSPrimitiveWrapperValue_616(state_, p_o);
}
...
return StoreJSPrimitiveWrapperValue_617(state_, p_o, p_v);
}
...
return LoadJSArgumentsObjectWithLengthLength_618(state_, p_o);
}
...
return StoreJSArgumentsObjectWithLengthLength_619(state_, p_o, p_v);
}
...
return LoadJSSloppyArgumentsObjectCallee_620(state_, p_o);
}
...
return StoreJSSloppyArgumentsObjectCallee_621(state_, p_o, p_v);
}
...
return LoadJSArrayIteratorIteratedObject_622(state_, p_o);
}
...
return StoreJSArrayIteratorIteratedObject_623(state_, p_o, p_v);
}
...
return LoadJSArrayIteratorNextIndex_624(state_, p_o);
}
...
return LoadCallHandlerInfoCallback_630(state_, p_o);
}
...
return StoreCallHandlerInfoCallback_631(state_, p_o, p_v);
}
...
return LoadCallHandlerInfoJsCallback_632(state_, p_o);
}
...
return LoadSourceTextModuleCode_646(state_, p_o);
}
...
return StoreSourceTextModuleCode_647(state_, p_o, p_v);
}
...
return LoadSourceTextModuleRegularExports_648(state_, p_o);
}
...
return StoreSourceTextModuleRegularExports_649(state_, p_o, p_v);
}
...
return LoadSourceTextModuleRegularImports_650(state_, p_o);
}
...
return StoreSourceTextModuleRegularImports_651(state_, p_o, p_v);
}
...
return LoadSourceTextModuleRequestedModules_652(state_, p_o);
}
...
return StoreSourceTextModuleRequestedModules_653(state_, p_o, p_v);
}
...
return LoadSourceTextModuleScript_654(state_, p_o);
}
...
return StoreSourceTextModuleScript_655(state_, p_o, p_v);
}
...
return LoadSourceTextModuleImportMeta_656(state_, p_o);
}
...
return StoreSourceTextModuleImportMeta_657(state_, p_o, p_v);
}
...
return LoadSourceTextModuleDfsIndex_658(state_, p_o);
}
...
return StoreSourceTextModuleDfsIndex_659(state_, p_o, p_v);
}
...
return LoadSourceTextModuleDfsAncestorIndex_660(state_, p_o);
}
...
return StoreSyntheticModuleName_663(state_, p_o, p_v);
}
...
return LoadSyntheticModuleExportNames_664(state_, p_o);
}
...
return StoreSyntheticModuleExportNames_665(state_, p_o, p_v);
}
...
return LoadSyntheticModuleEvaluationSteps_666(state_, p_o);
}
...
return StoreSyntheticModuleEvaluationSteps_667(state_, p_o, p_v);
}
...
return LoadJSModuleNamespaceModule_668(state_, p_o);
}
...
return StoreJSModuleNamespaceModule_669(state_, p_o, p_v);
}
...
return LoadJSWeakCollectionTable_670(state_, p_o);
}
...
return StoreJSWeakCollectionTable_671(state_, p_o, p_v);
}
...
return LoadJSCollectionIteratorTable_672(state_, p_o);
}
...
return StoreJSCollectionIteratorTable_673(state_, p_o, p_v);
}
...
return LoadJSCollectionIteratorIndex_674(state_, p_o);
}
...
return StoreJSCollectionIteratorIndex_675(state_, p_o, p_v);
}
...
return LoadJSMessageObjectMessageType_676(state_, p_o);
}
...
return StoreJSMessageObjectMessageType_677(state_, p_o, p_v);
}
...
return LoadJSMessageObjectArguments_678(state_, p_o);
}
...
return StoreJSMessageObjectArguments_679(state_, p_o, p_v);
}
...
return LoadJSMessageObjectScript_680(state_, p_o);
}
...
return StoreJSMessageObjectScript_681(state_, p_o, p_v);
}
...
return LoadJSMessageObjectStackFrames_682(state_, p_o);
}
...
return StoreJSMessageObjectStackFrames_683(state_, p_o, p_v);
}
...
return LoadJSMessageObjectSharedInfo_684(state_, p_o);
}
...
return StoreJSMessageObjectSharedInfo_685(state_, p_o, p_v);
}
...
return LoadJSMessageObjectBytecodeOffset_686(state_, p_o);
}
...
return StoreJSMessageObjectBytecodeOffset_687(state_, p_o, p_v);
}
...
return LoadJSMessageObjectStartPosition_688(state_, p_o);
}
...
return StoreJSMessageObjectStartPosition_689(state_, p_o, p_v);
}
...
return LoadJSMessageObjectEndPosition_690(state_, p_o);
}
...
return StoreJSMessageObjectEndPosition_691(state_, p_o, p_v);
}
...
return LoadJSMessageObjectErrorLevel_692(state_, p_o);
}
...
return StoreWeakArrayListLength_697(state_, p_o, p_v);
}
...
return LoadPrototypeInfoJsModuleNamespace_698(state_, p_o);
}
...
return StorePrototypeInfoJsModuleNamespace_699(state_, p_o, p_v);
}
...
return LoadPrototypeInfoPrototypeUsers_700(state_, p_o);
}
...
return StorePrototypeInfoRegistrySlot_703(state_, p_o, p_v);
}
...
return LoadPrototypeInfoValidityCell_704(state_, p_o);
}
...
return StorePrototypeInfoValidityCell_705(state_, p_o, p_v);
}
...
return LoadPrototypeInfoObjectCreateMap_706(state_, p_o);
}
...
return LoadScriptEvalFromSharedOrWrappedArguments_726(state_, p_o);
}
...
return StoreScriptHostDefinedOptions_739(state_, p_o, p_v);
}
...
return LoadEmbedderDataArrayLength_740(state_, p_o);
}
...
return StorePreparseDataInnerLength_745(state_, p_o, p_v);
}
...
return LoadInterpreterDataBytecodeArray_746(state_, p_o);
}
...
return StoreInterpreterDataBytecodeArray_747(state_, p_o, p_v);
}
...
return LoadInterpreterDataInterpreterTrampoline_748(state_, p_o);
}
...
return StoreInterpreterDataInterpreterTrampoline_749(state_, p_o, p_v);
}
...
return LoadSharedFunctionInfoFunctionData_750(state_, p_o);
}
...
return StoreSharedFunctionInfoFunctionData_751(state_, p_o, p_v);
}
...
return LoadSharedFunctionInfoNameOrScopeInfo_752(state_, p_o);
}
...
return StoreSharedFunctionInfoNameOrScopeInfo_753(state_, p_o, p_v);
}
...
return LoadSharedFunctionInfoOuterScopeInfoOrFeedbackMetadata_754(state_, p_o);
}
...
return StoreSharedFunctionInfoOuterScopeInfoOrFeedbackMetadata_755(state_, p_o, p_v);
}
...
return LoadSharedFunctionInfoScriptOrDebugInfo_756(state_, p_o);
}
...
return StoreSharedFunctionInfoScriptOrDebugInfo_757(state_, p_o, p_v);
}
...
return LoadSharedFunctionInfoLength_758(state_, p_o);
}
...
return StoreSharedFunctionInfoLength_759(state_, p_o, p_v);
}
...
return LoadSharedFunctionInfoFormalParameterCount_760(state_, p_o);
}
...
return StoreSharedFunctionInfoFormalParameterCount_761(state_, p_o, p_v);
}
...
return LoadSharedFunctionInfoExpectedNofProperties_762(state_, p_o);
}
...
return StoreSharedFunctionInfoExpectedNofProperties_763(state_, p_o, p_v);
}
...
return LoadSharedFunctionInfoFunctionTokenOffset_764(state_, p_o);
}
...
return StoreSharedFunctionInfoFunctionTokenOffset_765(state_, p_o, p_v);
}
...
return LoadSharedFunctionInfoFlags_766(state_, p_o);
}
...
return StoreSharedFunctionInfoFlags_767(state_, p_o, p_v);
}
...
return LoadSharedFunctionInfoFunctionLiteralId_768(state_, p_o);
}
...
return StoreSharedFunctionInfoFunctionLiteralId_769(state_, p_o, p_v);
}
...
return LoadJSBoundFunctionBoundTargetFunction_770(state_, p_o);
}
...
return StoreJSBoundFunctionBoundTargetFunction_771(state_, p_o, p_v);
}
...
return LoadJSBoundFunctionBoundThis_772(state_, p_o);
}
...
return StoreJSBoundFunctionBoundThis_773(state_, p_o, p_v);
}
...
return LoadJSBoundFunctionBoundArguments_774(state_, p_o);
}
...
return LoadJSArrayBufferByteLength_782(state_, p_o);
}
...
return StoreJSArrayBufferByteLength_783(state_, p_o, p_v);
}
...
return LoadJSArrayBufferBackingStore_784(state_, p_o);
}
...
return StoreJSArrayBufferBackingStore_785(state_, p_o, p_v);
}
...
return LoadJSArrayBufferViewBuffer_786(state_, p_o);
}
...
return StoreJSArrayBufferViewBuffer_787(state_, p_o, p_v);
}
...
return LoadJSArrayBufferViewByteOffset_788(state_, p_o);
}
...
return StoreJSArrayBufferViewByteOffset_789(state_, p_o, p_v);
}
...
return LoadJSArrayBufferViewByteLength_790(state_, p_o);
}
...
return StoreJSTypedArrayLength_793(state_, p_o, p_v);
}
...
return LoadJSTypedArrayExternalPointer_794(state_, p_o);
}
...
return LoadJSGlobalObjectNativeContext_818(state_, p_o);
}
...
return StoreJSGlobalObjectNativeContext_819(state_, p_o, p_v);
}
...
return LoadJSGlobalObjectGlobalProxy_820(state_, p_o);
}
...
return StoreJSGlobalObjectGlobalProxy_821(state_, p_o, p_v);
}
...
return LoadJSAsyncFromSyncIteratorSyncIterator_822(state_, p_o);
}
...
return StoreJSAsyncFromSyncIteratorSyncIterator_823(state_, p_o, p_v);
}
...
return LoadJSAsyncFromSyncIteratorNext_824(state_, p_o);
}
...
return StoreJSAsyncFromSyncIteratorNext_825(state_, p_o, p_v);
}
...
return LoadJSStringIteratorString_826(state_, p_o);
}
...
return StoreJSStringIteratorString_827(state_, p_o, p_v);
}
...
return LoadJSStringIteratorNextIndex_828(state_, p_o);
}
...
return StoreTemplateInfoTag_831(state_, p_o, p_v);
}
...
return LoadTemplateInfoSerialNumber_832(state_, p_o);
}
...
return StoreTemplateInfoSerialNumber_833(state_, p_o, p_v);
}
...
return LoadTemplateInfoNumberOfProperties_834(state_, p_o);
}
...
return StoreTemplateInfoNumberOfProperties_835(state_, p_o, p_v);
}
...
return LoadTemplateInfoPropertyList_836(state_, p_o);
}
...
return StoreTemplateInfoPropertyList_837(state_, p_o, p_v);
}
...
return LoadTemplateInfoPropertyAccessors_838(state_, p_o);
}
...
return StoreTemplateInfoPropertyAccessors_839(state_, p_o, p_v);
}
...
return LoadTemplateObjectDescriptionRawStrings_840(state_, p_o);
}
...
return StoreTemplateObjectDescriptionRawStrings_841(state_, p_o, p_v);
}
...
return LoadTemplateObjectDescriptionCookedStrings_842(state_, p_o);
}
...
return StoreTemplateObjectDescriptionCookedStrings_843(state_, p_o, p_v);
}
...
return LoadFunctionTemplateRareDataPrototypeTemplate_844(state_, p_o);
}
...
return StoreFunctionTemplateRareDataPrototypeTemplate_845(state_, p_o, p_v);
}
...
return LoadFunctionTemplateRareDataPrototypeProviderTemplate_846(state_, p_o);
}
...
return StoreFunctionTemplateRareDataPrototypeProviderTemplate_847(state_, p_o, p_v);
}
...
return LoadFunctionTemplateRareDataParentTemplate_848(state_, p_o);
}
...
return StoreFunctionTemplateRareDataParentTemplate_849(state_, p_o, p_v);
}
...
return LoadFunctionTemplateRareDataNamedPropertyHandler_850(state_, p_o);
}
...
return StoreFunctionTemplateRareDataNamedPropertyHandler_851(state_, p_o, p_v);
}
...
return LoadFunctionTemplateRareDataIndexedPropertyHandler_852(state_, p_o);
}
...
return StoreFunctionTemplateRareDataIndexedPropertyHandler_853(state_, p_o, p_v);
}
...
return LoadFunctionTemplateRareDataInstanceTemplate_854(state_, p_o);
}
...
return StoreFunctionTemplateRareDataInstanceTemplate_855(state_, p_o, p_v);
}
...
return LoadFunctionTemplateRareDataInstanceCallHandler_856(state_, p_o);
}
...
return StoreFunctionTemplateRareDataInstanceCallHandler_857(state_, p_o, p_v);
}
...
return LoadFunctionTemplateRareDataAccessCheckInfo_858(state_, p_o);
}
...
return StoreFunctionTemplateRareDataAccessCheckInfo_859(state_, p_o, p_v);
}
...
return LoadFunctionTemplateInfoCallCode_860(state_, p_o);
}
...
return StoreFunctionTemplateInfoCallCode_861(state_, p_o, p_v);
}
...
return LoadFunctionTemplateInfoClassName_862(state_, p_o);
}
...
return StoreFunctionTemplateInfoClassName_863(state_, p_o, p_v);
}
...
return LoadFunctionTemplateInfoSignature_864(state_, p_o);
}
...
return StoreFunctionTemplateInfoSignature_865(state_, p_o, p_v);
}
...
return LoadFunctionTemplateInfoRareData_866(state_, p_o);
}
...
return StoreFunctionTemplateInfoRareData_867(state_, p_o, p_v);
}
...
return LoadFunctionTemplateInfoSharedFunctionInfo_868(state_, p_o);
}
...
return StoreFunctionTemplateInfoSharedFunctionInfo_869(state_, p_o, p_v);
}
...
return LoadFunctionTemplateInfoFlag_870(state_, p_o);
}
...
return StoreFunctionTemplateInfoFlag_871(state_, p_o, p_v);
}
...
return LoadFunctionTemplateInfoLength_872(state_, p_o);
}
...
return StoreFunctionTemplateInfoLength_873(state_, p_o, p_v);
}
...
return LoadFunctionTemplateInfoCachedPropertyName_874(state_, p_o);
}
...
return StoreFunctionTemplateInfoCachedPropertyName_875(state_, p_o, p_v);
}
...
return LoadObjectTemplateInfoConstructor_876(state_, p_o);
}
...
return StoreObjectTemplateInfoConstructor_877(state_, p_o, p_v);
}
...
return LoadObjectTemplateInfoData_878(state_, p_o);
}
...
return StoreObjectTemplateInfoData_879(state_, p_o, p_v);
}
...
return LoadPropertyArrayLengthAndHash_880(state_, p_o);
}
...
return StorePropertyCellName_883(state_, p_o, p_v);
}
...
return LoadPropertyCellPropertyDetailsRaw_884(state_, p_o);
}
...
return StorePropertyCellValue_887(state_, p_o, p_v);
}
...
return LoadPropertyCellDependentCode_888(state_, p_o);
}
...
return StoreJSDataViewDataPointer_891(state_, p_o, p_v);
}
...
return LoadInterceptorInfoGetter_892(state_, p_o);
}
...
return StoreInterceptorInfoGetter_893(state_, p_o, p_v);
}
...
return LoadInterceptorInfoSetter_894(state_, p_o);
}
...
return StoreInterceptorInfoQuery_897(state_, p_o, p_v);
}
...
return LoadInterceptorInfoDescriptor_898(state_, p_o);
}
...
return StoreInterceptorInfoDescriptor_899(state_, p_o, p_v);
}
...
return LoadInterceptorInfoDeleter_900(state_, p_o);
}
...
return StoreInterceptorInfoDeleter_901(state_, p_o, p_v);
}
...
return LoadInterceptorInfoEnumerator_902(state_, p_o);
}
...
return StoreInterceptorInfoEnumerator_903(state_, p_o, p_v);
}
...
return LoadInterceptorInfoDefiner_904(state_, p_o);
}
...
return StoreInterceptorInfoFlags_909(state_, p_o, p_v);
}
...
return LoadAccessCheckInfoCallback_910(state_, p_o);
}
...
return StoreAccessCheckInfoCallback_911(state_, p_o, p_v);
}
...
return LoadAccessCheckInfoNamedInterceptor_912(state_, p_o);
}
...
return StoreAccessCheckInfoNamedInterceptor_913(state_, p_o, p_v);
}
...
return LoadAccessCheckInfoIndexedInterceptor_914(state_, p_o);
}
...
return StoreAccessCheckInfoData_917(state_, p_o, p_v);
}
...
return LoadArrayBoilerplateDescriptionFlags_918(state_, p_o);
}
...
return StoreArrayBoilerplateDescriptionFlags_919(state_, p_o, p_v);
}
...
return LoadArrayBoilerplateDescriptionConstantElements_920(state_, p_o);
}
...
return StoreArrayBoilerplateDescriptionConstantElements_921(state_, p_o, p_v);
}
...
return LoadAliasedArgumentsEntryAliasedContextSlot_922(state_, p_o);
}
...
return StoreDataHandlerData3_935(state_, p_o, p_v);
}
...
return LoadJSGeneratorObjectFunction_936(state_, p_o);
}
...
return StoreJSGeneratorObjectFunction_937(state_, p_o, p_v);
}
...
return LoadJSGeneratorObjectContext_938(state_, p_o);
}
...
return StoreJSGeneratorObjectContext_939(state_, p_o, p_v);
}
...
return LoadJSGeneratorObjectReceiver_940(state_, p_o);
}
...
return StoreJSGeneratorObjectReceiver_941(state_, p_o, p_v);
}
...
return LoadJSGeneratorObjectInputOrDebugPos_942(state_, p_o);
}
...
return StoreJSGeneratorObjectInputOrDebugPos_943(state_, p_o, p_v);
}
...
return LoadJSGeneratorObjectResumeMode_944(state_, p_o);
}
...
return StoreJSGeneratorObjectResumeMode_945(state_, p_o, p_v);
}
...
return LoadJSGeneratorObjectContinuation_946(state_, p_o);
}
...
return StoreJSGeneratorObjectContinuation_947(state_, p_o, p_v);
}
...
return LoadJSGeneratorObjectParametersAndRegisters_948(state_, p_o);
}
...
return StoreJSGeneratorObjectParametersAndRegisters_949(state_, p_o, p_v);
}
...
return LoadJSAsyncFunctionObjectPromise_950(state_, p_o);
}
...
return StoreJSAsyncFunctionObjectPromise_951(state_, p_o, p_v);
}
...
return LoadJSAsyncGeneratorObjectQueue_952(state_, p_o);
}
...
return StoreJSAsyncGeneratorObjectQueue_953(state_, p_o, p_v);
}
...
return LoadJSAsyncGeneratorObjectIsAwaiting_954(state_, p_o);
}
...
return StoreCallbackTaskData_963(state_, p_o, p_v);
}
...
return LoadCallableTaskCallable_964(state_, p_o);
}
...
return StoreStackFrameInfoLineNumber_969(state_, p_o, p_v);
}
...
return LoadStackFrameInfoColumnNumber_970(state_, p_o);
}
...
return StoreStackFrameInfoColumnNumber_971(state_, p_o, p_v);
}
...
return LoadStackFrameInfoPromiseAllIndex_972(state_, p_o);
}
...
return StoreStackFrameInfoScriptId_975(state_, p_o, p_v);
}
...
return LoadStackFrameInfoScriptName_976(state_, p_o);
}
...
return StoreStackFrameInfoScriptName_977(state_, p_o, p_v);
}
...
return LoadStackFrameInfoScriptNameOrSourceUrl_978(state_, p_o);
}
...
return StoreStackFrameInfoScriptNameOrSourceUrl_979(state_, p_o, p_v);
}
...
return LoadStackFrameInfoFunctionName_980(state_, p_o);
}
...
return StoreStackFrameInfoFunctionName_981(state_, p_o, p_v);
}
...
return LoadStackFrameInfoMethodName_982(state_, p_o);
}
...
return StoreStackFrameInfoMethodName_983(state_, p_o, p_v);
}
...
return LoadStackFrameInfoTypeName_984(state_, p_o);
}
...
return StoreStackFrameInfoTypeName_985(state_, p_o, p_v);
}
...
return LoadStackFrameInfoEvalOrigin_986(state_, p_o);
}
...
return StoreStackFrameInfoEvalOrigin_987(state_, p_o, p_v);
}
...
return LoadStackFrameInfoWasmModuleName_988(state_, p_o);
}
...
return StoreStackFrameInfoWasmModuleName_989(state_, p_o, p_v);
}
...
return LoadStackFrameInfoWasmInstance_990(state_, p_o);
}
...
return StoreStackFrameInfoFlag_993(state_, p_o, p_v);
}
...
return LoadStackTraceFrameFrameArray_994(state_, p_o);
}
...
return StoreStackTraceFrameFrameArray_995(state_, p_o, p_v);
}
...
return LoadStackTraceFrameFrameIndex_996(state_, p_o);
}
...
return StoreStackTraceFrameFrameIndex_997(state_, p_o, p_v);
}
...
return LoadStackTraceFrameFrameInfo_998(state_, p_o);
}
...
return StoreClassPositionsEnd_1005(state_, p_o, p_v);
}
...
return LoadWasmExportedFunctionDataWrapperCode_1006(state_, p_o);
}
...
return StoreWasmExportedFunctionDataWrapperCode_1007(state_, p_o, p_v);
}
...
return LoadWasmExportedFunctionDataInstance_1008(state_, p_o);
}
...
return StoreWasmExportedFunctionDataInstance_1009(state_, p_o, p_v);
}
...
return LoadWasmExportedFunctionDataJumpTableOffset_1010(state_, p_o);
}
...
return StoreWasmExportedFunctionDataJumpTableOffset_1011(state_, p_o, p_v);
}
...
return LoadWasmExportedFunctionDataFunctionIndex_1012(state_, p_o);
}
...
return StoreWasmExportedFunctionDataFunctionIndex_1013(state_, p_o, p_v);
}
...
return LoadWasmExportedFunctionDataCWrapperCode_1014(state_, p_o);
}
...
return StoreWasmExportedFunctionDataCWrapperCode_1015(state_, p_o, p_v);
}
...
return LoadWasmExportedFunctionDataWasmCallTarget_1016(state_, p_o);
}
...
return StoreWasmExportedFunctionDataWasmCallTarget_1017(state_, p_o, p_v);
}
...
return LoadWasmExportedFunctionDataPackedArgsSize_1018(state_, p_o);
}
...
return StoreWasmExportedFunctionDataPackedArgsSize_1019(state_, p_o, p_v);
}
...
return LoadWasmJSFunctionDataCallable_1020(state_, p_o);
}
...
return StoreWasmJSFunctionDataCallable_1021(state_, p_o, p_v);
}
...
return LoadWasmJSFunctionDataWrapperCode_1022(state_, p_o);
}
...
return StoreWasmJSFunctionDataWrapperCode_1023(state_, p_o, p_v);
}
...
return LoadWasmJSFunctionDataSerializedReturnCount_1024(state_, p_o);
}
...
return StoreWasmJSFunctionDataSerializedReturnCount_1025(state_, p_o, p_v);
}
...
return LoadWasmJSFunctionDataSerializedParameterCount_1026(state_, p_o);
}
...
return StoreWasmJSFunctionDataSerializedParameterCount_1027(state_, p_o, p_v);
}
...
return LoadWasmJSFunctionDataSerializedSignature_1028(state_, p_o);
}
...
return StoreWasmJSFunctionDataSerializedSignature_1029(state_, p_o, p_v);
}
...
return LoadWasmCapiFunctionDataCallTarget_1030(state_, p_o);
}
...
return StoreWasmCapiFunctionDataCallTarget_1031(state_, p_o, p_v);
}
...
return LoadWasmCapiFunctionDataEmbedderData_1032(state_, p_o);
}
...
return StoreWasmCapiFunctionDataEmbedderData_1033(state_, p_o, p_v);
}
...
return LoadWasmCapiFunctionDataWrapperCode_1034(state_, p_o);
}
...
return StoreWasmCapiFunctionDataWrapperCode_1035(state_, p_o, p_v);
}
...
return LoadWasmCapiFunctionDataSerializedSignature_1036(state_, p_o);
}
...
return StoreWasmCapiFunctionDataSerializedSignature_1037(state_, p_o, p_v);
}
...
return LoadWasmIndirectFunctionTableSize_1038(state_, p_o);
}
...
return StoreWasmIndirectFunctionTableSize_1039(state_, p_o, p_v);
}
...
return LoadWasmIndirectFunctionTableSigIds_1040(state_, p_o);
}
...
return StoreWasmIndirectFunctionTableSigIds_1041(state_, p_o, p_v);
}
...
return LoadWasmIndirectFunctionTableTargets_1042(state_, p_o);
}
...
return StoreWasmIndirectFunctionTableTargets_1043(state_, p_o, p_v);
}
...
return LoadWasmIndirectFunctionTableManagedNativeAllocations_1044(state_, p_o);
}
...
return StoreWasmIndirectFunctionTableManagedNativeAllocations_1045(state_, p_o, p_v);
}
...
return LoadWasmIndirectFunctionTableRefs_1046(state_, p_o);
}
...
return StoreWasmIndirectFunctionTableRefs_1047(state_, p_o, p_v);
}
...
return LoadWasmDebugInfoInstance_1048(state_, p_o);
}
...
return StoreWasmDebugInfoInstance_1049(state_, p_o, p_v);
}
...
return LoadWasmDebugInfoInterpreterHandle_1050(state_, p_o);
}
...
return StoreWasmDebugInfoInterpreterHandle_1051(state_, p_o, p_v);
}
...
return LoadWasmDebugInfoLocalsNames_1052(state_, p_o);
}
...
return StoreWasmDebugInfoLocalsNames_1053(state_, p_o, p_v);
}
...
return LoadWasmDebugInfoCWasmEntries_1054(state_, p_o);
}
...
return StoreWasmDebugInfoCWasmEntries_1055(state_, p_o, p_v);
}
...
return LoadWasmDebugInfoCWasmEntryMap_1056(state_, p_o);
}
...
return StoreWasmExceptionTagIndex_1059(state_, p_o, p_v);
}
...
return LoadAsyncGeneratorRequestNext_1060(state_, p_o);
}
...
return StoreAsyncGeneratorRequestNext_1061(state_, p_o, p_v);
}
...
return LoadAsyncGeneratorRequestResumeMode_1062(state_, p_o);
}
...
return StoreAsyncGeneratorRequestResumeMode_1063(state_, p_o, p_v);
}
...
return LoadAsyncGeneratorRequestValue_1064(state_, p_o);
}
...
return StoreAsyncGeneratorRequestValue_1065(state_, p_o, p_v);
}
...
return LoadAsyncGeneratorRequestPromise_1066(state_, p_o);
}
...
return StoreAsyncGeneratorRequestPromise_1067(state_, p_o, p_v);
}
...
return LoadSourceTextModuleInfoEntryExportName_1068(state_, p_o);
}
...
return StoreSourceTextModuleInfoEntryExportName_1069(state_, p_o, p_v);
}
...
return LoadSourceTextModuleInfoEntryLocalName_1070(state_, p_o);
}
...
return StoreSourceTextModuleInfoEntryLocalName_1071(state_, p_o, p_v);
}
...
return LoadSourceTextModuleInfoEntryImportName_1072(state_, p_o);
}
...
return StoreSourceTextModuleInfoEntryImportName_1073(state_, p_o, p_v);
}
...
return LoadSourceTextModuleInfoEntryModuleRequest_1074(state_, p_o);
}
...
return StoreSourceTextModuleInfoEntryModuleRequest_1075(state_, p_o, p_v);
}
...
return LoadSourceTextModuleInfoEntryCellIndex_1076(state_, p_o);
}
...
return StoreSourceTextModuleInfoEntryCellIndex_1077(state_, p_o, p_v);
}
...
return LoadSourceTextModuleInfoEntryBegPos_1078(state_, p_o);
}
...
return StoreSourceTextModuleInfoEntryBegPos_1079(state_, p_o, p_v);
}
...
return LoadSourceTextModuleInfoEntryEndPos_1080(state_, p_o);
}
...
return StoreSourceTextModuleInfoEntryEndPos_1081(state_, p_o, p_v);
}
...
return LoadPromiseCapabilityPromise_1082(state_, p_o);
}
...
return StorePromiseCapabilityPromise_1083(state_, p_o, p_v);
}
...
return LoadPromiseCapabilityResolve_1084(state_, p_o);
}
...
return StorePromiseCapabilityResolve_1085(state_, p_o, p_v);
}
...
return LoadPromiseCapabilityReject_1086(state_, p_o);
}
...
return StorePromiseReactionNext_1089(state_, p_o, p_v);
}
...
return LoadPromiseReactionRejectHandler_1090(state_, p_o);
}
...
return StorePromiseReactionRejectHandler_1091(state_, p_o, p_v);
}
...
return LoadPromiseReactionFulfillHandler_1092(state_, p_o);
}
...
return StorePromiseReactionFulfillHandler_1093(state_, p_o, p_v);
}
...
return LoadPromiseReactionPromiseOrCapability_1094(state_, p_o);
}
...
return StorePromiseReactionPromiseOrCapability_1095(state_, p_o, p_v);
}
...
return LoadPromiseReactionJobTaskArgument_1096(state_, p_o);
}
...
return StorePromiseReactionJobTaskArgument_1097(state_, p_o, p_v);
}
...
return LoadPromiseReactionJobTaskContext_1098(state_, p_o);
}
...
return StorePromiseReactionJobTaskContext_1099(state_, p_o, p_v);
}
...
return LoadPromiseReactionJobTaskHandler_1100(state_, p_o);
}
...
return StorePromiseReactionJobTaskHandler_1101(state_, p_o, p_v);
}
...
return LoadPromiseReactionJobTaskPromiseOrCapability_1102(state_, p_o);
}
...
return StorePromiseReactionJobTaskPromiseOrCapability_1103(state_, p_o, p_v);
}
...
return LoadPromiseResolveThenableJobTaskContext_1104(state_, p_o);
}
...
return StorePromiseResolveThenableJobTaskContext_1105(state_, p_o, p_v);
}
...
return LoadPromiseResolveThenableJobTaskPromiseToResolve_1106(state_, p_o);
}
...
return StorePromiseResolveThenableJobTaskPromiseToResolve_1107(state_, p_o, p_v);
}
...
return LoadPromiseResolveThenableJobTaskThen_1108(state_, p_o);
}
...
return StorePromiseResolveThenableJobTaskThen_1109(state_, p_o, p_v);
}
...
return LoadPromiseResolveThenableJobTaskThenable_1110(state_, p_o);
}
...
return StoreJSRegExpResultGroups_1123(state_, p_o, p_v);
}
...
return LoadJSRegExpStringIteratorIteratingRegExp_1124(state_, p_o);
}
...
return StoreJSRegExpStringIteratorIteratingRegExp_1125(state_, p_o, p_v);
}
...
return LoadJSRegExpStringIteratorIteratedString_1126(state_, p_o);
}
...
return StoreJSRegExpStringIteratorIteratedString_1127(state_, p_o, p_v);
}
...
return LoadJSRegExpStringIteratorFlags_1128(state_, p_o);
}
...
return StoreAccessorInfoFlags_1133(state_, p_o, p_v);
}
...
return LoadAccessorInfoExpectedReceiverType_1134(state_, p_o);
}
...
return StoreAccessorPairSetter_1147(state_, p_o, p_v);
}
...
return LoadDebugInfoSharedFunctionInfo_1148(state_, p_o);
}
...
return StoreDebugInfoScript_1153(state_, p_o, p_v);
}
...
return LoadDebugInfoOriginalBytecodeArray_1154(state_, p_o);
}
...
return StoreDebugInfoOriginalBytecodeArray_1155(state_, p_o, p_v);
}
...
return LoadDebugInfoDebugBytecodeArray_1156(state_, p_o);
}
...
return StoreDebugInfoCoverageInfo_1163(state_, p_o, p_v);
}
...
return LoadFeedbackVectorSharedFunctionInfo_1164(state_, p_o);
}
...
return StoreFeedbackVectorSharedFunctionInfo_1165(state_, p_o, p_v);
}
...
return LoadFeedbackVectorOptimizedCodeWeakOrSmi_1166(state_, p_o);
}
...
return StoreFeedbackVectorOptimizedCodeWeakOrSmi_1167(state_, p_o, p_v);
}
...
return LoadFeedbackVectorClosureFeedbackCellArray_1168(state_, p_o);
}
...
return StoreFeedbackVectorLength_1171(state_, p_o, p_v);
}
...
return LoadFeedbackVectorInvocationCount_1172(state_, p_o);
}
...
return StoreFeedbackVectorInvocationCount_1173(state_, p_o, p_v);
}
...
return LoadFeedbackVectorProfilerTicks_1174(state_, p_o);
}
...
return StoreFeedbackVectorProfilerTicks_1175(state_, p_o, p_v);
}
...
return LoadFeedbackVectorPadding_1176(state_, p_o);
}
...
return StoreFeedbackCellValue_1179(state_, p_o, p_v);
}
...
return LoadFeedbackCellInterruptBudget_1180(state_, p_o);
}
...
return StoreFeedbackCellInterruptBudget_1181(state_, p_o, p_v);
}
...
return LoadAllocationMementoAllocationSite_1182(state_, p_o);
}
...
return StoreAllocationMementoAllocationSite_1183(state_, p_o, p_v);
}
...
return LoadWasmModuleObjectNativeModule_1184(state_, p_o);
}
...
return StoreWasmModuleObjectNativeModule_1185(state_, p_o, p_v);
}
...
return LoadWasmModuleObjectExportWrappers_1186(state_, p_o);
}
...
return StoreWasmModuleObjectExportWrappers_1187(state_, p_o, p_v);
}
...
return LoadWasmModuleObjectScript_1188(state_, p_o);
}
...
return StoreWasmModuleObjectScript_1189(state_, p_o, p_v);
}
...
return LoadWasmModuleObjectWeakInstanceList_1190(state_, p_o);
}
...
return StoreWasmModuleObjectWeakInstanceList_1191(state_, p_o, p_v);
}
...
return LoadWasmModuleObjectAsmJsOffsetTable_1192(state_, p_o);
}
...
return StoreWasmModuleObjectAsmJsOffsetTable_1193(state_, p_o, p_v);
}
...
return LoadWasmModuleObjectBreakPointInfos_1194(state_, p_o);
}
...
return StoreWasmModuleObjectBreakPointInfos_1195(state_, p_o, p_v);
}
...
return LoadWasmTableObjectEntries_1196(state_, p_o);
}
...
return StoreWasmTableObjectEntries_1197(state_, p_o, p_v);
}
...
return LoadWasmTableObjectMaximumLength_1198(state_, p_o);
}
...
return StoreWasmTableObjectMaximumLength_1199(state_, p_o, p_v);
}
...
return LoadWasmTableObjectDispatchTables_1200(state_, p_o);
}
...
return StoreWasmTableObjectRawType_1203(state_, p_o, p_v);
}
...
return LoadWasmMemoryObjectArrayBuffer_1204(state_, p_o);
}
...
return StoreWasmMemoryObjectArrayBuffer_1205(state_, p_o, p_v);
}
...
return LoadWasmMemoryObjectMaximumPages_1206(state_, p_o);
}
...
return StoreWasmMemoryObjectMaximumPages_1207(state_, p_o, p_v);
}
...
return LoadWasmMemoryObjectInstances_1208(state_, p_o);
}
...
return StoreWasmMemoryObjectInstances_1209(state_, p_o, p_v);
}
...
return LoadWasmGlobalObjectUntaggedBuffer_1210(state_, p_o);
}
...
return StoreWasmGlobalObjectUntaggedBuffer_1211(state_, p_o, p_v);
}
...
return LoadWasmGlobalObjectTaggedBuffer_1212(state_, p_o);
}
...
return StoreWasmGlobalObjectFlags_1217(state_, p_o, p_v);
}
...
return LoadWasmExceptionObjectSerializedSignature_1218(state_, p_o);
}
...
return StoreWasmExceptionObjectSerializedSignature_1219(state_, p_o, p_v);
}
...
return LoadWasmExceptionObjectExceptionTag_1220(state_, p_o);
}
...
return StoreWasmExceptionObjectExceptionTag_1221(state_, p_o, p_v);
}
...
return LoadAsmWasmDataManagedNativeModule_1222(state_, p_o);
}
...
return StoreAsmWasmDataManagedNativeModule_1223(state_, p_o, p_v);
}
...
return LoadAsmWasmDataExportWrappers_1224(state_, p_o);
}
...
return StoreAsmWasmDataExportWrappers_1225(state_, p_o, p_v);
}
...
return LoadAsmWasmDataAsmJsOffsetTable_1226(state_, p_o);
}
...
return StoreAsmWasmDataAsmJsOffsetTable_1227(state_, p_o, p_v);
}
...
return LoadAsmWasmDataUsesBitset_1228(state_, p_o);
}
...
return StoreAsmWasmDataUsesBitset_1229(state_, p_o, p_v);
}
...
return LoadJSFinalizationGroupNativeContext_1230(state_, p_o);
}
...
return StoreJSFinalizationGroupNativeContext_1231(state_, p_o, p_v);
}
...
return LoadJSFinalizationGroupCleanup_1232(state_, p_o);
}
...
return StoreJSFinalizationGroupCleanup_1233(state_, p_o, p_v);
}
...
return LoadJSFinalizationGroupActiveCells_1234(state_, p_o);
}
...
return StoreJSFinalizationGroupActiveCells_1235(state_, p_o, p_v);
}
...
return LoadJSFinalizationGroupClearedCells_1236(state_, p_o);
}
...
return StoreJSFinalizationGroupClearedCells_1237(state_, p_o, p_v);
}
...
return LoadJSFinalizationGroupKeyMap_1238(state_, p_o);
}
...
return StoreJSFinalizationGroupKeyMap_1239(state_, p_o, p_v);
}
...
return LoadJSFinalizationGroupNext_1240(state_, p_o);
}
...
return StoreJSFinalizationGroupNext_1241(state_, p_o, p_v);
}
...
return LoadJSFinalizationGroupFlags_1242(state_, p_o);
}
...
return StoreJSFinalizationGroupFlags_1243(state_, p_o, p_v);
}
...
return LoadJSFinalizationGroupCleanupIteratorFinalizationGroup_1244(state_, p_o);
}
...
return StoreJSFinalizationGroupCleanupIteratorFinalizationGroup_1245(state_, p_o, p_v);
}
...
return LoadWeakCellFinalizationGroup_1246(state_, p_o);
}
...
return StoreJSWeakRefTarget_1263(state_, p_o, p_v);
}
...
return LoadBytecodeArrayConstantPool_1264(state_, p_o);
}
...
return StoreBytecodeArrayConstantPool_1265(state_, p_o, p_v);
}
...
return LoadBytecodeArrayHandlerTable_1266(state_, p_o);
}
...
return StoreBytecodeArrayHandlerTable_1267(state_, p_o, p_v);
}
...
return LoadBytecodeArraySourcePositionTable_1268(state_, p_o);
}
...
return StoreBytecodeArrayFrameSize_1271(state_, p_o, p_v);
}
...
return LoadBytecodeArrayParameterSize_1272(state_, p_o);
}
...
return StoreBytecodeArrayParameterSize_1273(state_, p_o, p_v);
}
...
return LoadBytecodeArrayIncomingNewTargetOrGeneratorRegister_1274(state_, p_o);
}
...
return StoreBytecodeArrayIncomingNewTargetOrGeneratorRegister_1275(state_, p_o, p_v);
}
...
return LoadBytecodeArrayOsrNestingLevel_1276(state_, p_o);
}
...
return StoreBytecodeArrayOsrNestingLevel_1277(state_, p_o, p_v);
}
...
return LoadBytecodeArrayBytecodeAge_1278(state_, p_o);
}
...
return StoreSortStateInitialReceiverMap_1283(state_, p_o, p_v);
}
...
return LoadSortStateInitialReceiverLength_1284(state_, p_o);
}
...
return StoreSortStateUserCmpFn_1287(state_, p_o, p_v);
}
...
return LoadSortStateSortComparePtr_1288(state_, p_o);
}
...
return StoreSortStateDeleteFn_1295(state_, p_o, p_v);
}
...
return LoadSortStateCanUseSameAccessorFn_1296(state_, p_o);
}
...
return StoreInternalClassB_1315(state_, p_o, p_v);
}
compiler::TNode<Smi> TorqueGeneratedExportedMacrosAssembler::LoadSmiPairA(compiler::TNode<SmiPair> p_o){
return LoadSmiPairA_1316(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreSmiPairA(compiler::TNode<SmiPair> p_o, compiler::TNode<Smi> p_v){
return StoreSmiPairA_1317(state_, p_o, p_v);
}
compiler::TNode<Smi> TorqueGeneratedExportedMacrosAssembler::LoadSmiPairB(compiler::TNode<SmiPair> p_o){
return LoadSmiPairB_1318(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreSmiPairB(compiler::TNode<SmiPair> p_o, compiler::TNode<Smi> p_v){
return StoreSmiPairB_1319(state_, p_o, p_v);
}
compiler::TNode<Smi> TorqueGeneratedExportedMacrosAssembler::LoadSmiBoxValue(compiler::TNode<SmiBox> p_o){
return LoadSmiBoxValue_1320(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreSmiBoxValue(compiler::TNode<SmiBox> p_o, compiler::TNode<Smi> p_v){
return StoreSmiBoxValue_1321(state_, p_o, p_v);
}
compiler::TNode<Smi> TorqueGeneratedExportedMacrosAssembler::LoadSmiBoxUnrelated(compiler::TNode<SmiBox> p_o){
return LoadSmiBoxUnrelated_1322(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreSmiBoxUnrelated(compiler::TNode<SmiBox> p_o, compiler::TNode<Smi> p_v){
return StoreSmiBoxUnrelated_1323(state_, p_o, p_v);
}
compiler::TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSDateTimeFormatIcuLocale(compiler::TNode<JSDateTimeFormat> p_o){
return LoadJSDateTimeFormatIcuLocale_1324(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSDateTimeFormatIcuLocale(compiler::TNode<JSDateTimeFormat> p_o, compiler::TNode<Foreign> p_v){
return StoreJSDateTimeFormatIcuLocale_1325(state_, p_o, p_v);
}
compiler::TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSDateTimeFormatIcuSimpleDateFormat(compiler::TNode<JSDateTimeFormat> p_o){
return LoadJSDateTimeFormatIcuSimpleDateFormat_1326(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSDateTimeFormatIcuSimpleDateFormat(compiler::TNode<JSDateTimeFormat> p_o, compiler::TNode<Foreign> p_v){
return StoreJSDateTimeFormatIcuSimpleDateFormat_1327(state_, p_o, p_v);
}
compiler::TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSDateTimeFormatIcuDateIntervalFormat(compiler::TNode<JSDateTimeFormat> p_o){
return LoadJSDateTimeFormatIcuDateIntervalFormat_1328(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSDateTimeFormatIcuDateIntervalFormat(compiler::TNode<JSDateTimeFormat> p_o, compiler::TNode<Foreign> p_v){
return StoreJSDateTimeFormatIcuDateIntervalFormat_1329(state_, p_o, p_v);
}
compiler::TNode<HeapObject> TorqueGeneratedExportedMacrosAssembler::LoadJSDateTimeFormatBoundFormat(compiler::TNode<JSDateTimeFormat> p_o){
return LoadJSDateTimeFormatBoundFormat_1330(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSDateTimeFormatBoundFormat(compiler::TNode<JSDateTimeFormat> p_o, compiler::TNode<HeapObject> p_v){
return StoreJSDateTimeFormatBoundFormat_1331(state_, p_o, p_v);
}
compiler::TNode<Smi> TorqueGeneratedExportedMacrosAssembler::LoadJSDateTimeFormatFlags(compiler::TNode<JSDateTimeFormat> p_o){
return LoadJSDateTimeFormatFlags_1332(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSDateTimeFormatFlags(compiler::TNode<JSDateTimeFormat> p_o, compiler::TNode<Smi> p_v){
return StoreJSDateTimeFormatFlags_1333(state_, p_o, p_v);
}
compiler::TNode<String> TorqueGeneratedExportedMacrosAssembler::LoadJSListFormatLocale(compiler::TNode<JSListFormat> p_o){
return LoadJSListFormatLocale_1334(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSListFormatLocale(compiler::TNode<JSListFormat> p_o, compiler::TNode<String> p_v){
return StoreJSListFormatLocale_1335(state_, p_o, p_v);
}
compiler::TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSListFormatIcuFormatter(compiler::TNode<JSListFormat> p_o){
return LoadJSListFormatIcuFormatter_1336(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSListFormatIcuFormatter(compiler::TNode<JSListFormat> p_o, compiler::TNode<Foreign> p_v){
return StoreJSListFormatIcuFormatter_1337(state_, p_o, p_v);
}
compiler::TNode<Smi> TorqueGeneratedExportedMacrosAssembler::LoadJSListFormatFlags(compiler::TNode<JSListFormat> p_o){
return LoadJSListFormatFlags_1338(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSListFormatFlags(compiler::TNode<JSListFormat> p_o, compiler::TNode<Smi> p_v){
return StoreJSListFormatFlags_1339(state_, p_o, p_v);
}
compiler::TNode<String> TorqueGeneratedExportedMacrosAssembler::LoadJSNumberFormatLocale(compiler::TNode<JSNumberFormat> p_o){
return LoadJSNumberFormatLocale_1340(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSNumberFormatLocale(compiler::TNode<JSNumberFormat> p_o, compiler::TNode<String> p_v){
return StoreJSNumberFormatLocale_1341(state_, p_o, p_v);
}
compiler::TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSNumberFormatIcuNumberFormatter(compiler::TNode<JSNumberFormat> p_o){
return LoadJSNumberFormatIcuNumberFormatter_1342(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSNumberFormatIcuNumberFormatter(compiler::TNode<JSNumberFormat> p_o, compiler::TNode<Foreign> p_v){
return StoreJSNumberFormatIcuNumberFormatter_1343(state_, p_o, p_v);
}
compiler::TNode<HeapObject> TorqueGeneratedExportedMacrosAssembler::LoadJSNumberFormatBoundFormat(compiler::TNode<JSNumberFormat> p_o){
return LoadJSNumberFormatBoundFormat_1344(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSNumberFormatBoundFormat(compiler::TNode<JSNumberFormat> p_o, compiler::TNode<HeapObject> p_v){
return StoreJSNumberFormatBoundFormat_1345(state_, p_o, p_v);
}
compiler::TNode<Smi> TorqueGeneratedExportedMacrosAssembler::LoadJSNumberFormatFlags(compiler::TNode<JSNumberFormat> p_o){
return LoadJSNumberFormatFlags_1346(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSNumberFormatFlags(compiler::TNode<JSNumberFormat> p_o, compiler::TNode<Smi> p_v){
return StoreJSNumberFormatFlags_1347(state_, p_o, p_v);
}
compiler::TNode<String> TorqueGeneratedExportedMacrosAssembler::LoadJSPluralRulesLocale(compiler::TNode<JSPluralRules> p_o){
return LoadJSPluralRulesLocale_1348(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSPluralRulesLocale(compiler::TNode<JSPluralRules> p_o, compiler::TNode<String> p_v){
return StoreJSPluralRulesLocale_1349(state_, p_o, p_v);
}
compiler::TNode<Smi> TorqueGeneratedExportedMacrosAssembler::LoadJSPluralRulesFlags(compiler::TNode<JSPluralRules> p_o){
return LoadJSPluralRulesFlags_1350(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSPluralRulesFlags(compiler::TNode<JSPluralRules> p_o, compiler::TNode<Smi> p_v){
return StoreJSPluralRulesFlags_1351(state_, p_o, p_v);
}
compiler::TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSPluralRulesIcuPluralRules(compiler::TNode<JSPluralRules> p_o){
return LoadJSPluralRulesIcuPluralRules_1352(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSPluralRulesIcuPluralRules(compiler::TNode<JSPluralRules> p_o, compiler::TNode<Foreign> p_v){
return StoreJSPluralRulesIcuPluralRules_1353(state_, p_o, p_v);
}
compiler::TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSPluralRulesIcuNumberFormatter(compiler::TNode<JSPluralRules> p_o){
return LoadJSPluralRulesIcuNumberFormatter_1354(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSPluralRulesIcuNumberFormatter(compiler::TNode<JSPluralRules> p_o, compiler::TNode<Foreign> p_v){
return StoreJSPluralRulesIcuNumberFormatter_1355(state_, p_o, p_v);
}
compiler::TNode<String> TorqueGeneratedExportedMacrosAssembler::LoadJSRelativeTimeFormatLocale(compiler::TNode<JSRelativeTimeFormat> p_o){
return LoadJSRelativeTimeFormatLocale_1356(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSRelativeTimeFormatLocale(compiler::TNode<JSRelativeTimeFormat> p_o, compiler::TNode<String> p_v){
return StoreJSRelativeTimeFormatLocale_1357(state_, p_o, p_v);
}
compiler::TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSRelativeTimeFormatIcuFormatter(compiler::TNode<JSRelativeTimeFormat> p_o){
return LoadJSRelativeTimeFormatIcuFormatter_1358(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSRelativeTimeFormatIcuFormatter(compiler::TNode<JSRelativeTimeFormat> p_o, compiler::TNode<Foreign> p_v){
return StoreJSRelativeTimeFormatIcuFormatter_1359(state_, p_o, p_v);
}
compiler::TNode<Smi> TorqueGeneratedExportedMacrosAssembler::LoadJSRelativeTimeFormatFlags(compiler::TNode<JSRelativeTimeFormat> p_o){
return LoadJSRelativeTimeFormatFlags_1360(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSRelativeTimeFormatFlags(compiler::TNode<JSRelativeTimeFormat> p_o, compiler::TNode<Smi> p_v){
return StoreJSRelativeTimeFormatFlags_1361(state_, p_o, p_v);
}
compiler::TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSLocaleIcuLocale(compiler::TNode<JSLocale> p_o){
return LoadJSLocaleIcuLocale_1362(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSLocaleIcuLocale(compiler::TNode<JSLocale> p_o, compiler::TNode<Foreign> p_v){
return StoreJSLocaleIcuLocale_1363(state_, p_o, p_v);
}
compiler::TNode<String> TorqueGeneratedExportedMacrosAssembler::LoadJSSegmenterLocale(compiler::TNode<JSSegmenter> p_o){
return LoadJSSegmenterLocale_1364(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSSegmenterLocale(compiler::TNode<JSSegmenter> p_o, compiler::TNode<String> p_v){
return StoreJSSegmenterLocale_1365(state_, p_o, p_v);
}
compiler::TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSSegmenterIcuBreakIterator(compiler::TNode<JSSegmenter> p_o){
return LoadJSSegmenterIcuBreakIterator_1366(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSSegmenterIcuBreakIterator(compiler::TNode<JSSegmenter> p_o, compiler::TNode<Foreign> p_v){
return StoreJSSegmenterIcuBreakIterator_1367(state_, p_o, p_v);
}
compiler::TNode<Smi> TorqueGeneratedExportedMacrosAssembler::LoadJSSegmenterFlags(compiler::TNode<JSSegmenter> p_o){
return LoadJSSegmenterFlags_1368(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSSegmenterFlags(compiler::TNode<JSSegmenter> p_o, compiler::TNode<Smi> p_v){
return StoreJSSegmenterFlags_1369(state_, p_o, p_v);
}
compiler::TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSSegmentIteratorIcuBreakIterator(compiler::TNode<JSSegmentIterator> p_o){
return LoadJSSegmentIteratorIcuBreakIterator_1370(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSSegmentIteratorIcuBreakIterator(compiler::TNode<JSSegmentIterator> p_o, compiler::TNode<Foreign> p_v){
return StoreJSSegmentIteratorIcuBreakIterator_1371(state_, p_o, p_v);
}
compiler::TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSSegmentIteratorUnicodeString(compiler::TNode<JSSegmentIterator> p_o){
return LoadJSSegmentIteratorUnicodeString_1372(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSSegmentIteratorUnicodeString(compiler::TNode<JSSegmentIterator> p_o, compiler::TNode<Foreign> p_v){
return StoreJSSegmentIteratorUnicodeString_1373(state_, p_o, p_v);
}
compiler::TNode<Smi> TorqueGeneratedExportedMacrosAssembler::LoadJSSegmentIteratorFlags(compiler::TNode<JSSegmentIterator> p_o){
return LoadJSSegmentIteratorFlags_1374(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSSegmentIteratorFlags(compiler::TNode<JSSegmentIterator> p_o, compiler::TNode<Smi> p_v){
return StoreJSSegmentIteratorFlags_1375(state_, p_o, p_v);
}
compiler::TNode<String> TorqueGeneratedExportedMacrosAssembler::LoadJSV8BreakIteratorLocale(compiler::TNode<JSV8BreakIterator> p_o){
return LoadJSV8BreakIteratorLocale_1376(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSV8BreakIteratorLocale(compiler::TNode<JSV8BreakIterator> p_o, compiler::TNode<String> p_v){
return StoreJSV8BreakIteratorLocale_1377(state_, p_o, p_v);
}
compiler::TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSV8BreakIteratorBreakIterator(compiler::TNode<JSV8BreakIterator> p_o){
return LoadJSV8BreakIteratorBreakIterator_1378(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSV8BreakIteratorBreakIterator(compiler::TNode<JSV8BreakIterator> p_o, compiler::TNode<Foreign> p_v){
return StoreJSV8BreakIteratorBreakIterator_1379(state_, p_o, p_v);
}
compiler::TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSV8BreakIteratorUnicodeString(compiler::TNode<JSV8BreakIterator> p_o){
return LoadJSV8BreakIteratorUnicodeString_1380(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSV8BreakIteratorUnicodeString(compiler::TNode<JSV8BreakIterator> p_o, compiler::TNode<Foreign> p_v){
return StoreJSV8BreakIteratorUnicodeString_1381(state_, p_o, p_v);
}
compiler::TNode<HeapObject> TorqueGeneratedExportedMacrosAssembler::LoadJSV8BreakIteratorBoundAdoptText(compiler::TNode<JSV8BreakIterator> p_o){
return LoadJSV8BreakIteratorBoundAdoptText_1382(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSV8BreakIteratorBoundAdoptText(compiler::TNode<JSV8BreakIterator> p_o, compiler::TNode<HeapObject> p_v){
return StoreJSV8BreakIteratorBoundAdoptText_1383(state_, p_o, p_v);
}
compiler::TNode<HeapObject> TorqueGeneratedExportedMacrosAssembler::LoadJSV8BreakIteratorBoundFirst(compiler::TNode<JSV8BreakIterator> p_o){
return LoadJSV8BreakIteratorBoundFirst_1384(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSV8BreakIteratorBoundFirst(compiler::TNode<JSV8BreakIterator> p_o, compiler::TNode<HeapObject> p_v){
return StoreJSV8BreakIteratorBoundFirst_1385(state_, p_o, p_v);
}
compiler::TNode<HeapObject> TorqueGeneratedExportedMacrosAssembler::LoadJSV8BreakIteratorBoundNext(compiler::TNode<JSV8BreakIterator> p_o){
return LoadJSV8BreakIteratorBoundNext_1386(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSV8BreakIteratorBoundNext(compiler::TNode<JSV8BreakIterator> p_o, compiler::TNode<HeapObject> p_v){
return StoreJSV8BreakIteratorBoundNext_1387(state_, p_o, p_v);
}
compiler::TNode<HeapObject> TorqueGeneratedExportedMacrosAssembler::LoadJSV8BreakIteratorBoundCurrent(compiler::TNode<JSV8BreakIterator> p_o){
return LoadJSV8BreakIteratorBoundCurrent_1388(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSV8BreakIteratorBoundCurrent(compiler::TNode<JSV8BreakIterator> p_o, compiler::TNode<HeapObject> p_v){
return StoreJSV8BreakIteratorBoundCurrent_1389(state_, p_o, p_v);
}
compiler::TNode<HeapObject> TorqueGeneratedExportedMacrosAssembler::LoadJSV8BreakIteratorBoundBreakType(compiler::TNode<JSV8BreakIterator> p_o){
return LoadJSV8BreakIteratorBoundBreakType_1390(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSV8BreakIteratorBoundBreakType(compiler::TNode<JSV8BreakIterator> p_o, compiler::TNode<HeapObject> p_v){
return StoreJSV8BreakIteratorBoundBreakType_1391(state_, p_o, p_v);
}
compiler::TNode<Smi> TorqueGeneratedExportedMacrosAssembler::LoadJSV8BreakIteratorBreakIteratorType(compiler::TNode<JSV8BreakIterator> p_o){
return LoadJSV8BreakIteratorBreakIteratorType_1392(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSV8BreakIteratorBreakIteratorType(compiler::TNode<JSV8BreakIterator> p_o, compiler::TNode<Smi> p_v){
return StoreJSV8BreakIteratorBreakIteratorType_1393(state_, p_o, p_v);
}
compiler::TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSCollatorIcuCollator(compiler::TNode<JSCollator> p_o){
return LoadJSCollatorIcuCollator_1394(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSCollatorIcuCollator(compiler::TNode<JSCollator> p_o, compiler::TNode<Foreign> p_v){
return StoreJSCollatorIcuCollator_1395(state_, p_o, p_v);
}
compiler::TNode<HeapObject> TorqueGeneratedExportedMacrosAssembler::LoadJSCollatorBoundCompare(compiler::TNode<JSCollator> p_o){
return LoadJSCollatorBoundCompare_1396(state_, p_o);
}
void TorqueGeneratedExportedMacrosAssembler::StoreJSCollatorBoundCompare(compiler::TNode<JSCollator> p_o, compiler::TNode<HeapObject> p_v){
return StoreJSCollatorBoundCompare_1397(state_, p_o, p_v);
}
}  // namespace internal
}  // namespace v8
