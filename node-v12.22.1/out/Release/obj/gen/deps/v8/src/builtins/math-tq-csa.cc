...
USE(parameter1);
  ...
  if (block14.is_used()) {
    ...
    USE(tmp106);
    std::tie(tmp105, tmp106) = UnsafeNewReference9ATfloat64_1420(state_, compiler::TNode<HeapObject>{tmp97}, compiler::TNode<IntPtrT>{tmp104}).Flatten();
  ...
  if (block35.is_used()) {
    ...
    USE(tmp407);
    std::tie(tmp406, tmp407) = UnsafeNewReference9ATfloat64_1420(state_, compiler::TNode<HeapObject>{tmp398}, compiler::TNode<IntPtrT>{tmp405}).Flatten();
