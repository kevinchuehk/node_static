...
compiler::TNode<JSStringIterator> NewJSStringIterator_333(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<String> p_string, compiler::TNode<Smi> p_nextIndex) {
  ...
  if (block0.is_used()) {
    ...
    CodeStubAssembler(state_).InitializeFieldsWithRoot(tmp7, CodeStubAssembler(state_).IntPtrConstant(20), compiler::TNode<IntPtrT>{tmp6}, RootIndex::kUndefinedValue);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    tmp2 = Cast16JSStringIterator_1466(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}, &label0);
...
compiler::TNode<JSStringIterator> Cast16JSStringIterator_1466(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, Object> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, Object> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
