...
const char* kBuiltinName_356(compiler::CodeAssemblerState* state_) {
...
compiler::TNode<Number> FindIndexAllElements_357(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSTypedArray> p_array, compiler::TNode<JSReceiver> p_callbackfn, compiler::TNode<Object> p_thisArg) {
  compiler::CodeAssembler ca_(state_);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-findindex.tq", 13);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-findindex.tq", 16);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-findindex.tq", 17);
  ...
  if (block15.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-findindex.tq", 19);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-findindex.tq", 20);
  ...
  if (block16.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-findindex.tq", 20);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-findindex.tq", 22);
  ...
  if (block17.is_used()) {
    ...
    USE(tmp150);
    tmp150 = CodeStubAssembler(state_).Call(compiler::TNode<Context>{tmp144}, compiler::TNode<JSReceiver>{tmp145}, compiler::TNode<Object>{tmp146}, compiler::TNode<Object>{tmp147}, compiler::TNode<Object>{tmp148}, compiler::TNode<Object>{tmp149});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-findindex.tq", 23);
    compiler::TNode<BoolT> tmp151;
    USE(tmp151);
    tmp151 = ToBoolean_240(state_, compiler::TNode<Object>{tmp150});
  ...
  if (block18.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-findindex.tq", 24);
  ...
  if (block10.is_used()) {
    ...
    USE(tmp183);
    tmp183 = FromConstexpr5ATSmi17ATconstexpr_int31_152(state_, 1);
  ...
  if (block8.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-findindex.tq", 27);
    compiler::TNode<Number> tmp194;
    USE(tmp194);
    tmp194 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_158(state_, -1);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-findindex.tq", 10);
  ...
  return compiler::TNode<Number>{tmp204};
}
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-findindex.tq", 37);
    compiler::TNode<JSTypedArray> tmp5;
    USE(tmp5);
    compiler::CodeAssemblerLabel label0(&ca_);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-findindex.tq", 39);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-findindex.tq", 41);
    ...
    USE(tmp37);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp37 = Cast71UT19ATCallableApiObject17ATCallableJSProxy15JSBoundFunction10JSFunction_1399(state_, compiler::TNode<Context>{tmp30}, compiler::TNode<Object>{tmp36}, &label0);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-findindex.tq", 42);
    compiler::TNode<IntPtrT> tmp55;
    USE(tmp55);
    tmp55 = FromConstexpr8ATintptr17ATconstexpr_int31_148(state_, 1);
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-findindex.tq", 43);
    compiler::TNode<Number> tmp57;
    USE(tmp57);
    tmp57 = FindIndexAllElements_357(state_, compiler::TNode<Context>{tmp49}, compiler::TNode<JSTypedArray>{tmp52}, compiler::TNode<JSReceiver>{tmp54}, compiler::TNode<Object>{tmp56});
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-findindex.tq", 46);
    compiler::TNode<IntPtrT> tmp63;
    USE(tmp63);
    tmp63 = FromConstexpr8ATintptr17ATconstexpr_int31_148(state_, 0);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-findindex.tq", 49);
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp68}, MessageTemplate::kNotTypedArray, kBuiltinName_356(state_));
  }
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-findindex.tq", 52);
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp73}, MessageTemplate::kDetachedOperation, kBuiltinName_356(state_));
  }
}
