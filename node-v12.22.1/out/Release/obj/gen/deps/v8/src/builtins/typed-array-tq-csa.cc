...
void TypedArrayMerge_384(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSTypedArray> p_array, compiler::TNode<JSReceiver> p_comparefn, compiler::TNode<FixedArray> p_source, compiler::TNode<Smi> p_from, compiler::TNode<Smi> p_middle, compiler::TNode<Smi> p_to, compiler::TNode<FixedArray> p_target) {
  ...
  if (block16.is_used()) {
    ...
    USE(tmp116);
    std::tie(tmp115, tmp116) = UnsafeNewReference20UT5ATSmi10HeapObject_1405(state_, compiler::TNode<HeapObject>{tmp107}, compiler::TNode<IntPtrT>{tmp114}).Flatten();
  ...
  if (block23.is_used()) {
    ...
    USE(tmp260);
    std::tie(tmp259, tmp260) = UnsafeNewReference20UT5ATSmi10HeapObject_1405(state_, compiler::TNode<HeapObject>{tmp251}, compiler::TNode<IntPtrT>{tmp258}).Flatten();
  ...
  if (block33.is_used()) {
    ...
    USE(tmp454);
    std::tie(tmp453, tmp454) = UnsafeNewReference20UT5ATSmi10HeapObject_1405(state_, compiler::TNode<HeapObject>{tmp445}, compiler::TNode<IntPtrT>{tmp452}).Flatten();
  ...
  if (block29.is_used()) {
    ...
    USE(tmp556);
    tmp556 = UnsafeCast90UT8ATBigInt7ATFalse6ATNull5ATSmi6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1406(state_, compiler::TNode<Context>{tmp537}, compiler::TNode<Object>{tmp555});
  ...
  if (block40.is_used()) {
    ...
    USE(tmp592);
    std::tie(tmp591, tmp592) = UnsafeNewReference20UT5ATSmi10HeapObject_1405(state_, compiler::TNode<HeapObject>{tmp583}, compiler::TNode<IntPtrT>{tmp590}).Flatten();
  ...
  if (block36.is_used()) {
    ...
    USE(tmp699);
    tmp699 = UnsafeCast90UT8ATBigInt7ATFalse6ATNull5ATSmi6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1406(state_, compiler::TNode<Context>{tmp679}, compiler::TNode<Object>{tmp698});
  ...
  if (block50.is_used()) {
    ...
    USE(tmp752);
    std::tie(tmp751, tmp752) = UnsafeNewReference20UT5ATSmi10HeapObject_1405(state_, compiler::TNode<HeapObject>{tmp743}, compiler::TNode<IntPtrT>{tmp750}).Flatten();
  ...
  if (block57.is_used()) {
    ...
    USE(tmp914);
    std::tie(tmp913, tmp914) = UnsafeNewReference20UT5ATSmi10HeapObject_1405(state_, compiler::TNode<HeapObject>{tmp905}, compiler::TNode<IntPtrT>{tmp912}).Flatten();
  ...
  if (block64.is_used()) {
    ...
    USE(tmp1085);
    std::tie(tmp1084, tmp1085) = UnsafeNewReference20UT5ATSmi10HeapObject_1405(state_, compiler::TNode<HeapObject>{tmp1076}, compiler::TNode<IntPtrT>{tmp1083}).Flatten();
  ...
  if (block71.is_used()) {
    ...
    USE(tmp1229);
    std::tie(tmp1228, tmp1229) = UnsafeNewReference20UT5ATSmi10HeapObject_1405(state_, compiler::TNode<HeapObject>{tmp1220}, compiler::TNode<IntPtrT>{tmp1227}).Flatten();
...
USE(parameter1);
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array.tq", 289);
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array.tq", 293);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array.tq", 297);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array.tq", 303);
  ...
  if (block12.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array.tq", 306);
    compiler::TNode<Smi> tmp131;
    USE(tmp131);
  ...
  if (block17.is_used()) {
    ...
    USE(tmp151);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp151 = Cast71UT19ATCallableApiObject17ATCallableJSProxy15JSBoundFunction10JSFunction_1399(state_, compiler::TNode<Context>{tmp145}, compiler::TNode<Object>{tmp147}, &label0);
  ...
  if (block18.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array.tq", 308);
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array.tq", 313);
    compiler::TNode<Int32T> tmp192;
    USE(tmp192);
    tmp192 = CodeStubAssembler(state_).LoadElementsKind(compiler::TNode<JSTypedArray>{tmp189});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array.tq", 315);
  ...
  if (block41.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array.tq", 335);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block23.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array.tq", 338);
  ...
  if (block56.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array.tq", 354);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block24.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array.tq", 361);
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array.tq", 364);
    compiler::TNode<Smi> tmp688;
    USE(tmp688);
  ...
  if (block66.is_used()) {
    ...
    USE(tmp763);
    std::tie(tmp762, tmp763) = UnsafeNewReference20UT5ATSmi10HeapObject_1405(state_, compiler::TNode<HeapObject>{tmp754}, compiler::TNode<IntPtrT>{tmp761}).Flatten();
  ...
  if (block73.is_used()) {
    ...
    USE(tmp934);
    std::tie(tmp933, tmp934) = UnsafeNewReference20UT5ATSmi10HeapObject_1405(state_, compiler::TNode<HeapObject>{tmp925}, compiler::TNode<IntPtrT>{tmp932}).Flatten();
  ...
  if (block59.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array.tq", 370);
    ...
    USE(tmp1100);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array.tq", 373);
    compiler::TNode<Smi> tmp1101;
    USE(tmp1101);
  ...
  if (block84.is_used()) {
    ...
    USE(tmp1177);
    std::tie(tmp1176, tmp1177) = UnsafeNewReference20UT5ATSmi10HeapObject_1405(state_, compiler::TNode<HeapObject>{tmp1168}, compiler::TNode<IntPtrT>{tmp1175}).Flatten();
  ...
  if (block80.is_used()) {
    ...
    USE(tmp1319);
    tmp1319 = UnsafeCast90UT8ATBigInt7ATFalse6ATNull5ATSmi6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1406(state_, compiler::TNode<Context>{tmp1295}, compiler::TNode<Object>{tmp1318});
  ...
  if (block77.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array.tq", 376);
