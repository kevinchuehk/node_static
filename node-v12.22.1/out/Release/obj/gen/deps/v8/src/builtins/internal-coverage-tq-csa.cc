...
compiler::TNode<FixedArray> GetCoverageInfo_306(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSFunction> p_function, compiler::CodeAssemblerLabel* label_IfNoCoverageInfo) {
  ...
  if (block8.is_used()) {
    ...
    USE(tmp39);
    tmp39 = UnsafeCast14ATCoverageInfo_1456(state_, compiler::TNode<Context>{tmp33}, compiler::TNode<Object>{tmp38});
...
void IncrementBlockCount_309(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<FixedArray> p_coverageInfo, compiler::TNode<Smi> p_slot) {
  ...
  if (block13.is_used()) {
    ...
    USE(tmp140);
    std::tie(tmp139, tmp140) = UnsafeNewReference20UT5ATSmi10HeapObject_1405(state_, compiler::TNode<HeapObject>{tmp131}, compiler::TNode<IntPtrT>{tmp138}).Flatten();
  ...
  if (block9.is_used()) {
    ...
    USE(tmp247);
    tmp247 = UnsafeCast5ATSmi_1404(state_, compiler::TNode<Context>{tmp227}, compiler::TNode<Object>{tmp246});
...
compiler::TNode<FixedArray> UnsafeCast14ATCoverageInfo_1456(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_o) {
  compiler::CodeAssembler ca_(state_);
