...
compiler::TNode<Object> LoadElementOrUndefined_51(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<FixedArray> p_a, compiler::TNode<Smi> p_i) {
  ...
  if (block6.is_used()) {
    ...
    USE(tmp29);
    std::tie(tmp28, tmp29) = UnsafeNewReference20UT5ATSmi10HeapObject_1405(state_, compiler::TNode<HeapObject>{tmp20}, compiler::TNode<IntPtrT>{tmp27}).Flatten();
  ...
  if (block2.is_used()) {
    ...
    USE(tmp91);
    tmp91 = UnsafeCast100UT8ATBigInt7ATFalse6ATNull5ATSmi9ATTheHole6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1434(state_, compiler::TNode<Context>{tmp80}, compiler::TNode<Object>{tmp90});
...
compiler::TNode<Object> LoadElementOrUndefined_52(compiler::CodeAssemblerState* state_, compiler::TNode<FixedDoubleArray> p_a, compiler::TNode<Smi> p_i) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block0, &tmp0, &tmp1);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array.tq", 42);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array.tq", 43);
...
void StoreArrayHole_54(compiler::CodeAssemblerState* state_, compiler::TNode<FixedArray> p_elements, compiler::TNode<Smi> p_k) {
  ...
  if (block6.is_used()) {
    ...
    compiler::TNode<IntPtrT> tmp27;
    USE(tmp27);
    std::tie(tmp26, tmp27) = UnsafeNewReference20UT5ATSmi10HeapObject_1405(state_, compiler::TNode<HeapObject>{tmp18}, compiler::TNode<IntPtrT>{tmp25}).Flatten();
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array.tq", 50);
...
compiler::TNode<Object> UnsafeCast100UT8ATBigInt7ATFalse6ATNull5ATSmi9ATTheHole6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1434(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_o) {
  compiler::CodeAssembler ca_(state_);
