...
compiler::TNode<Oddball> ForEachAllElements_359(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSTypedArray> p_array, compiler::TNode<JSReceiver> p_callbackfn, compiler::TNode<Object> p_thisArg) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-foreach.tq", 13);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-foreach.tq", 16);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-foreach.tq", 17);
  ...
  if (block15.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-foreach.tq", 19);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-foreach.tq", 20);
  ...
  if (block16.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-foreach.tq", 20);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-foreach.tq", 21);
  ...
  if (block10.is_used()) {
    ...
    USE(tmp160);
    tmp160 = FromConstexpr5ATSmi17ATconstexpr_int31_152(state_, 1);
    compiler::TNode<Smi> tmp161;
    USE(tmp161);
    tmp161 = CodeStubAssembler(state_).SmiAdd(compiler::TNode<Smi>{tmp159}, compiler::TNode<Smi>{tmp160});
  ...
  if (block8.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-foreach.tq", 23);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-foreach.tq", 10);
  ...
  return compiler::TNode<Oddball>{tmp181};
}
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-foreach.tq", 34);
    compiler::TNode<JSTypedArray> tmp5;
    USE(tmp5);
    compiler::CodeAssemblerLabel label0(&ca_);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-foreach.tq", 36);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-foreach.tq", 38);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-foreach.tq", 39);
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-foreach.tq", 40);
    compiler::TNode<Oddball> tmp57;
    USE(tmp57);
    tmp57 = ForEachAllElements_359(state_, compiler::TNode<Context>{tmp49}, compiler::TNode<JSTypedArray>{tmp52}, compiler::TNode<JSReceiver>{tmp54}, compiler::TNode<Object>{tmp56});
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-foreach.tq", 43);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-foreach.tq", 46);
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp68}, MessageTemplate::kNotTypedArray, kBuiltinName_358(state_));
  }
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/typed-array-foreach.tq", 49);
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp73}, MessageTemplate::kDetachedOperation, kBuiltinName_358(state_));
  }
}
