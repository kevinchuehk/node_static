...
compiler::TNode<JSDataView> ValidateDataView_272(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_o, compiler::TNode<String> p_method) {
  ...
  if (block0.is_used()) {
    ...
    tmp3 = Cast10JSDataView_1453(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}, &label0);
...
compiler::TNode<JSDataView> Cast10JSDataView_1453(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  compiler::CodeAssembler ca_(state_);
