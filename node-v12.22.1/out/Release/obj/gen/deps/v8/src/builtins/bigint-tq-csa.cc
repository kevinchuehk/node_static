...
compiler::TNode<BigInt> Convert8ATBigInt13MutableBigInt_256(compiler::CodeAssemblerState* state_, compiler::TNode<BigInt> p_i) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp1);
    tmp1 = Convert10BigIntBase13MutableBigInt_1449(state_, compiler::TNode<BigInt>{tmp0});
...
TF_BUILTIN(BigIntAdd, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp3);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp3 = Cast8ATBigInt_1450(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}, &label0);
  ...
  if (block5.is_used()) {
    ...
    USE(tmp13);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp13 = Cast8ATBigInt_1450(state_, compiler::TNode<Context>{tmp8}, compiler::TNode<Object>{tmp10}, &label0);
...
compiler::TNode<BigInt> Convert10BigIntBase13MutableBigInt_1449(compiler::CodeAssemblerState* state_, compiler::TNode<BigInt> p_i) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<BigInt> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<BigInt, BigInt> block1(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<BigInt, BigInt> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
compiler::TNode<BigInt> Cast8ATBigInt_1450(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  compiler::CodeAssembler ca_(state_);
