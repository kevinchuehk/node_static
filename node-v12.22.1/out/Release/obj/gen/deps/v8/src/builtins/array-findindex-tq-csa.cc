...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 17);
    compiler::TNode<JSReceiver> tmp6;
    USE(tmp6);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp6 = Cast10JSReceiver_1398(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}, &label0);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 18);
    compiler::TNode<JSReceiver> tmp35;
    USE(tmp35);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp35 = Cast71UT19ATCallableApiObject17ATCallableJSProxy15JSBoundFunction10JSFunction_1399(state_, compiler::TNode<Context>{tmp28}, compiler::TNode<Object>{tmp30}, &label0);
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 19);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 20);
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 23);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 22);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 34);
    CodeStubAssembler(state_).Unreachable();
  }
}
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 48);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 49);
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 50);
    compiler::TNode<Number> tmp86;
    USE(tmp86);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp86 = Cast20UT5ATSmi10HeapNumber_85(state_, compiler::TNode<Object>{tmp80}, &label0);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 51);
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 58);
    compiler::TNode<BoolT> tmp180;
    USE(tmp180);
    tmp180 = ToBoolean_240(state_, compiler::TNode<Object>{tmp175});
  ...
  if (block17.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 59);
  ...
  if (block18.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 63);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 62);
...
TF_BUILTIN(ArrayFindIndexLoopContinuation, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block0, &tmp0, &tmp1, &tmp2, &tmp3, &tmp4, &tmp5, &tmp6);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 72);
  ...
  if (block3.is_used()) {
    ...
    USE(tmp15);
    tmp15 = NumberIsLessThan_75(state_, compiler::TNode<Number>{tmp14}, compiler::TNode<Number>{tmp13});
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 78);
    compiler::TNode<Object> tmp24;
    USE(tmp24);
    tmp24 = CodeStubAssembler(state_).GetProperty(compiler::TNode<Context>{tmp16}, compiler::TNode<Object>{tmp20}, compiler::TNode<Object>{tmp23});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 82);
    compiler::TNode<Object> tmp25;
    USE(tmp25);
    tmp25 = CodeStubAssembler(state_).Call(compiler::TNode<Context>{tmp16}, compiler::TNode<JSReceiver>{tmp18}, compiler::TNode<Object>{tmp19}, compiler::TNode<Object>{tmp24}, compiler::TNode<Object>{tmp23}, compiler::TNode<Object>{tmp20});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 85);
    compiler::TNode<BoolT> tmp26;
    USE(tmp26);
    tmp26 = ToBoolean_240(state_, compiler::TNode<Object>{tmp25});
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 86);
  ...
  if (block4.is_used()) {
    ...
    USE(tmp55);
    tmp55 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_158(state_, 1);
    compiler::TNode<Number> tmp56;
    USE(tmp56);
    tmp56 = CodeStubAssembler(state_).NumberAdd(compiler::TNode<Number>{tmp54}, compiler::TNode<Number>{tmp55});
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 91);
    compiler::TNode<Smi> tmp65;
    USE(tmp65);
    tmp65 = Convert5ATSmi17ATconstexpr_int31_1400(state_, -1);
...
compiler::TNode<Number> FastArrayFindIndex_6(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSReceiver> p_o, compiler::TNode<Number> p_len, compiler::TNode<JSReceiver> p_callbackfn, compiler::TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 97);
    compiler::TNode<Smi> tmp5;
    USE(tmp5);
    tmp5 = FromConstexpr5ATSmi17ATconstexpr_int31_152(state_, 0);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 98);
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 99);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 100);
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 103);
  ...
  if (block21.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 104);
  ...
  if (block15.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 107);
  ...
  if (block23.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 109);
  ...
  if (block29.is_used()) {
    ...
    USE(tmp272);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp272 = LoadElementNoHole16FixedDoubleArray_235(state_, compiler::TNode<Context>{tmp270}, compiler::TNode<JSArray>{tmp261}, compiler::TNode<Smi>{tmp271}, &label0);
  ...
  if (block30.is_used()) {
    ...
    USE(tmp338);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp338 = LoadElementNoHole10FixedArray_234(state_, compiler::TNode<Context>{tmp336}, compiler::TNode<JSArray>{tmp327}, compiler::TNode<Smi>{tmp337}, &label0);
  ...
  if (block25.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 109);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 111);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/base.tq", 3093);
  ...
  if (block36.is_used()) {
    ...
    USE(tmp462);
    tmp462 = CodeStubAssembler(state_).Call(compiler::TNode<Context>{tmp456}, compiler::TNode<JSReceiver>{tmp457}, compiler::TNode<Object>{tmp458}, compiler::TNode<Object>{tmp459}, compiler::TNode<Object>{tmp460}, compiler::TNode<Object>{tmp461});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 110);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 112);
    compiler::TNode<BoolT> tmp463;
    USE(tmp463);
    tmp463 = ToBoolean_240(state_, compiler::TNode<Object>{tmp462});
  ...
  if (block37.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 113);
  ...
  if (block14.is_used()) {
    ...
    USE(tmp510);
    tmp510 = FromConstexpr5ATSmi17ATconstexpr_int31_152(state_, 1);
  ...
  if (block12.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 116);
    compiler::TNode<Number> tmp526;
    USE(tmp526);
    tmp526 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_158(state_, -1);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 94);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<Object> tmp4;
    ca_.Bind(&block0, &tmp0, &tmp1, &tmp2, &tmp3, &tmp4);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 124);
    compiler::TNode<Object> tmp5;
    USE(tmp5);
    tmp5 = RequireObjectCoercible_241(state_, compiler::TNode<Context>{tmp3}, compiler::TNode<Object>{tmp4}, "Array.prototype.findIndex");
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 127);
    compiler::TNode<JSReceiver> tmp6;
    USE(tmp6);
    tmp6 = CodeStubAssembler(state_).ToObject_Inline(compiler::TNode<Context>{tmp3}, compiler::TNode<Object>{tmp4});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 130);
    compiler::TNode<Number> tmp7;
    USE(tmp7);
    tmp7 = GetLengthProperty_244(state_, compiler::TNode<Context>{tmp3}, compiler::TNode<Object>{tmp6});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 133);
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 134);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 137);
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 140);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 144);
    compiler::TNode<Number> tmp83;
    USE(tmp83);
    compiler::TypedCodeAssemblerVariable<Smi> result_0_0(&ca_);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp83 = FastArrayFindIndex_6(state_, compiler::TNode<Context>{tmp77}, compiler::TNode<JSReceiver>{tmp79}, compiler::TNode<Number>{tmp80}, compiler::TNode<JSReceiver>{tmp81}, compiler::TNode<Object>{tmp82}, &label0, &result_0_0);
  ...
  if (block12.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 149);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 148);
    compiler::TNode<Number> tmp122;
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-findindex.tq", 153);
    compiler::TNode<IntPtrT> tmp128;
    USE(tmp128);
    tmp128 = FromConstexpr8ATintptr17ATconstexpr_int31_148(state_, 0);
    compiler::TNode<Object> tmp129;
    USE(tmp129);
...
compiler::TNode<Smi> Convert5ATSmi17ATconstexpr_int31_1400(compiler::CodeAssemblerState* state_, int31_t p_i) {
  compiler::CodeAssembler ca_(state_);
  ...
  if (block0.is_used()) {
    ...
    USE(tmp0);
    tmp0 = FromConstexpr5ATSmi17ATconstexpr_int31_152(state_, p_i);
