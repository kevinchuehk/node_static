...
compiler::TNode<JSObject> ObjectFromEntriesFastCase_310(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_iterable, compiler::CodeAssemblerLabel* label_IfSlow) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = Cast34ATFastJSArrayWithNoCustomIteration_1457(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}, &label0);
  ...
  if (block5.is_used()) {
    ...
    USE(tmp14);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp14 = Cast10FixedArray_103(state_, compiler::TNode<HeapObject>{tmp13}, &label0);
  ...
  if (block7.is_used()) {
    ...
    USE(tmp27);
    tmp27 = NewJSObject_55(state_, compiler::TNode<Context>{tmp20});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/object-fromentries.tq", 16);
    compiler::TNode<Smi> tmp28;
    USE(tmp28);
    tmp28 = FromConstexpr5ATSmi17ATconstexpr_int31_152(state_, 0);
  ...
  if (block9.is_used()) {
    ...
    USE(tmp46);
    tmp46 = LoadElementOrUndefined_51(state_, compiler::TNode<Context>{tmp38}, compiler::TNode<FixedArray>{tmp42}, compiler::TNode<Smi>{tmp45});
    ...
    USE(tmp48);
    compiler::CodeAssemblerLabel label0(&ca_);
    std::tie(tmp47, tmp48) = LoadKeyValuePairNoSideEffects_267(state_, compiler::TNode<Context>{tmp38}, compiler::TNode<Object>{tmp46}, &label0).Flatten();
  ...
  if (block13.is_used()) {
    ...
    USE(tmp71);
    tmp71 = Is10JSReceiver90UT8ATBigInt7ATFalse6ATNull5ATSmi6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1458(state_, compiler::TNode<Context>{tmp59}, compiler::TNode<Object>{tmp69});
...
USE(parameter1);
  ...
  if (block6.is_used()) {
    ...
    USE(tmp20);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp20 = ObjectFromEntriesFastCase_310(state_, compiler::TNode<Context>{tmp17}, compiler::TNode<Object>{tmp19}, &label0);
  ...
  if (block4.is_used()) {
    ...
    USE(tmp42);
    tmp42 = NewJSObject_55(state_, compiler::TNode<Context>{tmp39});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/object-fromentries.tq", 45);
    compiler::TNode<Map> tmp43;
    USE(tmp43);
    tmp43 = GetIteratorResultMap_225(state_, compiler::TNode<Context>{tmp39});
  ...
  if (block15.is_used()) {
    ...
    std::tie(tmp145, tmp146) = LoadKeyValuePair_268(state_, compiler::TNode<Context>{tmp135}, compiler::TNode<Object>{tmp143}).Flatten();
    }
...
compiler::TNode<JSArray> Cast34ATFastJSArrayWithNoCustomIteration_1457(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, Object> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, Object> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block3.is_used()) {
    ...
    USE(tmp10);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp10 = Cast34ATFastJSArrayWithNoCustomIteration_138(state_, compiler::TNode<Context>{tmp6}, compiler::TNode<HeapObject>{tmp9}, &label0);
...
compiler::TNode<BoolT> Is10JSReceiver90UT8ATBigInt7ATFalse6ATNull5ATSmi6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1458(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_o) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, Object> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ...
    USE(tmp2);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp2 = Cast10JSReceiver_1398(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}, &label0);
