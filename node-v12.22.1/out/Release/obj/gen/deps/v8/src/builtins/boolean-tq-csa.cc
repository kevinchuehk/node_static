...
USE(parameter3);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/boolean.tq", 10);
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/boolean.tq", 12);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/boolean.tq", 13);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/boolean.tq", 16);
    compiler::TNode<JSReceiver> tmp29;
    USE(tmp29);
    tmp29 = UnsafeCast10JSReceiver_1451(state_, compiler::TNode<Context>{tmp24}, compiler::TNode<Object>{tmp26});
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/boolean.tq", 19);
    ...
    USE(tmp32);
    tmp32 = UnsafeCast18JSPrimitiveWrapper_1452(state_, compiler::TNode<Context>{tmp24}, compiler::TNode<Object>{tmp31});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/boolean.tq", 20);
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/boolean.tq", 21);
    arguments.PopAndReturn(tmp32);
  }
}

compiler::TNode<JSReceiver> UnsafeCast10JSReceiver_1451(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_o) {
...
compiler::TNode<JSPrimitiveWrapper> UnsafeCast18JSPrimitiveWrapper_1452(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_o) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, Object> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
