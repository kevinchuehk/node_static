...
compiler::TNode<JSArray> HandleFastAliasedSloppyArgumentsSlice_39(compiler::CodeAssemblerState* state_, compiler::TNode<NativeContext> p_context, compiler::TNode<JSArgumentsObjectWithLength> p_args, compiler::TNode<Smi> p_start, compiler::TNode<Smi> p_count, compiler::CodeAssemblerLabel* label_Bailout) {
  ...
  if (block5.is_used()) {
    ...
    USE(tmp37);
    tmp37 = Convert8ATintptr17ATconstexpr_int31_1409(state_, SloppyArgumentsElements::kArgumentsIndex);
  ...
  if (block11.is_used()) {
    ...
    USE(tmp62);
    std::tie(tmp61, tmp62) = UnsafeNewReference20UT5ATSmi10HeapObject_1405(state_, compiler::TNode<HeapObject>{tmp53}, compiler::TNode<IntPtrT>{tmp60}).Flatten();
  ...
  if (block7.is_used()) {
    ...
    USE(tmp139);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp139 = Cast10FixedArray_1427(state_, compiler::TNode<Context>{tmp125}, compiler::TNode<Object>{tmp138}, &label0);
  ...
  if (block17.is_used()) {
    ...
    USE(tmp186);
    tmp186 = Convert8ATintptr17ATconstexpr_int31_1409(state_, SloppyArgumentsElements::kContextIndex);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/torque-internal.tq", 51);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/torque-internal.tq", 37);
  ...
  if (block18.is_used()) {
    ...
    USE(tmp300);
    tmp300 = UnsafeCast7Context_1428(state_, compiler::TNode<Context>{tmp284}, compiler::TNode<Object>{tmp299});
    ...
    USE(tmp306);
    tmp306 = UnsafeCast10FixedArray_1403(state_, compiler::TNode<Context>{tmp284}, compiler::TNode<Object>{tmp305});
  ...
  if (block36.is_used()) {
    ...
    USE(tmp537);
    tmp537 = UnsafeCast5ATSmi_1404(state_, compiler::TNode<Context>{tmp519}, compiler::TNode<Object>{tmp536});
  ...
  if (block44.is_used()) {
    ...
    USE(tmp598);
    std::tie(tmp597, tmp598) = UnsafeNewReference20UT5ATSmi10HeapObject_1405(state_, compiler::TNode<HeapObject>{tmp589}, compiler::TNode<IntPtrT>{tmp596}).Flatten();
  ...
  if (block38.is_used()) {
    ...
    USE(tmp773);
    tmp773 = UnsafeCast90UT8ATBigInt7ATFalse6ATNull5ATSmi6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1406(state_, compiler::TNode<Context>{tmp754}, compiler::TNode<Object>{tmp772});
...
compiler::TNode<JSArray> HandleFastSlice_40(compiler::CodeAssemblerState* state_, compiler::TNode<NativeContext> p_context, compiler::TNode<Object> p_o, compiler::TNode<Number> p_startNumber, compiler::TNode<Number> p_countNumber, compiler::CodeAssemblerLabel* label_Bailout) {
  ...
  if (block5.is_used()) {
    ...
    USE(tmp30);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp30 = Cast20ATFastJSArrayForCopy_1429(state_, compiler::TNode<Context>{tmp23}, compiler::TNode<Object>{tmp24}, &label0);
  ...
  if (block8.is_used()) {
    ...
    USE(tmp75);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp75 = Cast27JSArgumentsObjectWithLength_1430(state_, compiler::TNode<Context>{tmp68}, compiler::TNode<Object>{ca_.UncheckedCast<Object>(tmp74)}, &label0);
...
USE(parameter1);
  ...
  if (block1.is_used()) {
    ...
    USE(tmp12);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp12 = Cast20ATFastJSArrayForCopy_1429(state_, compiler::TNode<Context>{tmp10}, compiler::TNode<Object>{tmp11}, &label0);
  ...
  if (block17.is_used()) {
    ...
    USE(tmp205);
    tmp205 = UnsafeCast15ATNativeContext_1431(state_, compiler::TNode<Context>{tmp192}, compiler::TNode<Object>{tmp192});
  ...
  if (block19.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-slice.tq", 181);
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-slice.tq", 184);
    compiler::TNode<Number> tmp273;
    USE(tmp273);
    tmp273 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_158(state_, 0);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-slice.tq", 187);
  ...
  if (block23.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-slice.tq", 189);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-slice.tq", 192);
    ...
    USE(tmp307);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-slice.tq", 195);
  ...
  if (block26.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-slice.tq", 197);
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-slice.tq", 200);
  ...
  if (block27.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-slice.tq", 204);
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-slice.tq", 207);
  ...
  if (block24.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-slice.tq", 211);
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-slice.tq", 214);
    arguments.PopAndReturn(tmp366);
  }
}

compiler::TNode<FixedArray> Cast10FixedArray_1427(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  compiler::CodeAssembler ca_(state_);
...
compiler::TNode<Context> UnsafeCast7Context_1428(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_o) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, Object> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
compiler::TNode<JSArray> Cast20ATFastJSArrayForCopy_1429(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, Object> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, Object> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, Object, HeapObject> block3(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
compiler::TNode<JSArgumentsObjectWithLength> Cast27JSArgumentsObjectWithLength_1430(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, Object> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, Object> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, Object, HeapObject> block3(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
compiler::TNode<NativeContext> UnsafeCast15ATNativeContext_1431(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_o) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, Object> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
